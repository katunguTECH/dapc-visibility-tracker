...
export const metadata: Metadata = {
  // metadataBase ensures all relative image paths (/og-image...) 
  // are converted to absolute URLs that WhatsApp can read.
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og-image.jpg.svg", // Points to your SVG in the public folder
        width: 1200,
        height: 630,
