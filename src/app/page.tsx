    ...
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 selection:bg-blue-100">
      ...
      <main className="max-w-5xl mx-auto pt-20 pb-32 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm hover:shadow-xl transition-all group">
            ...
            <h3 style={{ fontWeight: 900, letterSpacing: "-0.03em" }} className="text-2xl text-slate-900 mb-4">
              Local Accuracy
            </h3>
      ...
      >
        ...
        <span
          ...
          className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 uppercase tracking-[0.2em] text-[11px] whitespace-nowrap"
        >
          Chat with us
        </span>
      </div>
