...
// Dynamically import client-only component to prevent SSR errors
const MpesaModal = dynamic(() => import("../components/MpesaModal"), { ssr: false });
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100">
      ...
      <header className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* AUDIT RESULTS */}
        {report ? <AuditDashboard report={report} /> : <EmptyDashboard />}
      </header>
...
// Extracted audit dashboard for clarity
function AuditDashboard({ report }: { report: any }) {
  return (
