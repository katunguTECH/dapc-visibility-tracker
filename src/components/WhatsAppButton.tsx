    ...
    >
      {showTooltip && show && (
        <div
          ...
          } bottom-1/2 translate-y-1/2 bg-gray-800 text-white text-sm rounded-lg px-3 py-2 whitespace-nowrap shadow-lg`}
        >
          {tooltipText}
          <div
            className={`absolute ${
              position === "right" ? "right-0 translate-x-full" : "left-0 -translate-x-full"
            } top-1/2 -translate-y-1/2 border-8 border-transparent ${
              position === "right" ? "border-l-gray-800" : "border-r-gray-800"
            }`}
          />
        </div>
      )}
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
          <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12c0 1.89.47 3.66 1.28 5.23L2 22l4.77-1.28A9.96 9.96 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.71 0-3.34-.46-4.77-1.28l-3.23.86.86-3.23A7.96 7.96 0 014 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8z" clipRule="evenodd" />
          <path fillRule="evenodd" d="M16.64 13.77c-.2-.1-1.18-.58-1.36-.65-.18-.07-.31-.1-.44.1-.13.2-.51.65-.63.78-.12.13-.24.15-.44.05-1.12-.48-1.86-.86-2.6-1.78-.17-.21-.1-.33.08-.44.2-.13.3-.22.44-.37.1-.13.05-.24-.03-.34-.08-.1-.69-1.66-.94-2.28-.12-.3-.24-.26-.33-.27-.09-.01-.19-.01-.29-.01s-.27.04-.41.2-.54.53-.54 1.29.55 1.5.63 1.6c.08.1 1.09 1.66 2.63 2.33.37.16.65.26.87.33.37.12.7.1.97.06.3-.04.95-.39 1.08-.77.13-.38.13-.71.09-.78-.04-.07-.15-.11-.35-.21z" clipRule="evenodd" />
        </svg>
      </a>
    </div>
  );
